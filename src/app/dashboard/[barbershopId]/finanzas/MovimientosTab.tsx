...
import FiltroFechas from '../ventas/FiltroFechas'
import GraficoIngresos from '../ventas/GraficoIngresos'
import BarberMobileAccordion from '../ventas/BarberMobileAccordion'
...
export default async function MovimientosTab({ barbershopId, desde, hasta, tipo = 'todos', pb, pp, p }: Props) {
  ...
  const baseHref = `?tab=movimientos&desde=${from}&hasta=${to}&tipo=${tipo}`
  ...
  return (
    <div>
      <FiltroFechas
        ...
        tipo={tipo}
        months={months}
        basePath={`/dashboard/${barbershopId}/finanzas?tab=movimientos`}
      />
        ...
        <div className={styles.filterRow}>
          ...
          <div className={styles.filterTabs}>
            {tipoTabs.map(t => (
              <a
                key={t.key}
                href={`?tab=movimientos&desde=${from}&hasta=${to}&tipo=${t.key}`}
