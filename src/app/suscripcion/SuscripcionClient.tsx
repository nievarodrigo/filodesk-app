...
export default function SuscripcionClient({ barbershopId, barbershopName, currentPlan, subscriptionStatus, trialEnd, plans }: Props) {
  ...
  // Guard clause para evitar crash si no hay planes (Issue Medium)
          ...
          {screen === 'plans' ? (
            ...
            <div style={{ width: '100%', maxWidth: 460, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <MethodCard active={method === 'transfer'} onClick={() => setMethod('transfer')} icon="🏦" title="Transferencia bancaria" subtitle="Desde cualquier banco · Rápido" badge="NUEVO" badgeColor="gold" />
              </div>
